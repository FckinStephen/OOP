...
int main()
{
	Circle* c = new Circle(8);				//Vytvoøení objektu tøídy Circle
	Cylinder* cyl = new Cylinder(5, 6, 7);	//Vytvoøení objektu tøídy Cylinder
	Rectangle* r = new Rectangle(6, 12);	//Vytvoøení objektu tøídy Rectangle
	Square* s = new Square(12);				//Vytvoøení objektu tøídy Square
