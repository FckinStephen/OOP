...
int main()
{
	Circle* c = new Circle(6);				//Vytvoøení objektu tøídy Circle
	Cylinder* cyl = new Cylinder(2, 4, 6);	//Vytvoøení objektu tøídy Cylinder
	Rectangle* r = new Rectangle(8, 12);	//Vytvoøení objektu tøídy Rectangle
	Square* s = new Square(5);				//Vytvoøení objektu tøídy Square
