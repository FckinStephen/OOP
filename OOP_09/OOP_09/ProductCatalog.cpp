...
Product* ProductCatalog::CreateProduct(int id, string name, float price, int numOfItems, int storageCap)
{
...
Phone* ProductCatalog::CreateProduct(int id, string name, float price, int numOfItems, string color, float screenSize, int storageCap)
{
...
Laptop* ProductCatalog::CreateProduct(int id, string name, float price, int numOfItems, float screenSize, int numOfCores, string graphiCard, bool backlitKey, int storageCap)
{
...
Tablet* ProductCatalog::CreateProduct(int id, string name, float price, int numOfItems, float screenSize, int batteryCapacity, int storageCap)
{
